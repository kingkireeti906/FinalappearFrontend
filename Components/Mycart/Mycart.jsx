...
import {productdata} from '../../Apis/product'
import { useNavigate } from 'react-router-dom'
import { useState } from 'react'
import { useEffect } from 'react'
import{quantityupdate} from '../../Apis/product'
...
// console.log(`fetched data is ${fetchedData  }`)
    ...
    const handleChangeQuantity = async (_id, value) => {
        try {
            ...
            fetchData();
            // If you need to update the local state with the new quantity from the response,
            // you can do that here after successfully updating the quantity in the database
        } catch (error) {
