...
import { deliverydata } from '../../Apis/product';
import { useLocation } from 'react-router-dom';
import { userdata } from '../../Apis/cart';
import { updateall } from '../../Apis/product';
            ...
            {isMobile ? (<div className={styles.mobContainer}>
                ...
                <div className={styles.review}>
                    ...
                    <div className={styles.images}>
                                        ...
                                        {data.map((imageUrl, index) => (
                                            <div key={index} className={styles.imgBox} onClick={() => handleItemClick(imageUrl)}>
                                                <img src={imageUrl.image_url} alt={`item-${index}`} className={styles.img} />
                                            </div>
                                        ))}
                                        </div>
                                        <div className={styles.productDetails}>
                                            <span className={styles.productName}>boat Rockers 551</span>
                ...
                <div className={styles.summaryBox}>
                    ...
                    <div className={styles.itemsBox}>
                        ...
                        <span className={styles.cost}>₹3000.00</span>
                    </div>
                ...
                <div className={styles.orderTotalBox}>
                    ...
                    <span className={styles.totalOrderCost}>₹3545.00</span>
                </div>
