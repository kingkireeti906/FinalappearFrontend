...
import { getdata } from '../../Apis/product';
import cart from '../../assets/cart.png';
import carticon from '../../assets/cartIcon.png';
import feedback from '../../assets/feedicon.jpeg';
import { updatequantity } from '../../Apis/product'
import { updateCardStatus } from '../../Apis/product'
import { updateDeliveryStatus } from '../../Apis/product'
import { getcount } from '../../Apis/product';
import { feedbackpost } from '../../Apis/feedback';
import home from '../../assets/home.jpeg';
import cartImg from '../../assets/cartimg.jpeg';
import invoiceFooter from '../../assets/invoiceFoot.jpeg';
import login from '../../assets/logout.jpeg';
                        ...
                        <div className={styles.content}>
                         ...
                         <div className={styles.dropDown}>
                             <select className={styles.filtering} onClick={handleSelectClick2}
                                 ...
                                 <option value="TOZO" className={styles.options}>TOZO</option>
                                 <option value="oneodio" className={styles.options}>OneOdio</option>
                                 <option value="Soundcore" className={styles.options}>Soundcore</option>
                                 ...
                                 <option value="Raycon" className={styles.options}>Raycon</option>
                                 <option value="ZIHNIC" className={styles.options}>ZIHNIC</option>
                         ...
                         <div className={styles.dropDown}>
                             ...
                             >
                                 ...
                                 <option value="Furious Red" className={styles.options}>Furious Red</option>
                                 <option value="Matte Blue" className={styles.options}>Matte Blue</option>
                                 <option value="Rose Gold" className={styles.options}>Rose Gold</option>
             ...
             <div className={styles.navBar}>
                 ...
                 <div className={styles.navBarText1}>
                     {!showCart ? (
                         ...
                         <span className={styles.logout}onClick={logoutfun}>Logout</span>
                     )}
                 </div>
                         ...
                         {fetchedData.map((item, index) => (
                             <div className={styles.boxlist} key={index}>
                                 <div className={styles.imgBoxList}>
                                     ...
                                     <img src={item.Images[0]} alt="headphone" className={showCart ? styles.productImgWithCarts : styles.productImgs} onClick={() => Productpage(index)} />
